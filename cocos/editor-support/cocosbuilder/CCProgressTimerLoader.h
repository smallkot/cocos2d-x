...
protected:
    ...
    virtual void onHandlePropTypePoint(cocos2d::Node *pNode, cocos2d::Node * pParent, const char *pPropertyName, const cocos2d::Point &pPoint, CCBReader * pCCBReader) override;
