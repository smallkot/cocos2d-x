...
class NodeLoader : public cocos2d::Ref {
    ...
    protected:
        ...
        virtual cocos2d::Color4B parsePropTypeColor3(cocos2d::Node * pNode, cocos2d::Node * pParent, CCBReader * ccbReader, const char *pPropertyName);
        ...
        virtual void onHandlePropTypeColor3(cocos2d::Node * pNode, cocos2d::Node * pParent, const char* pPropertyName, cocos2d::Color4B pColor3B, CCBReader * ccbReader);
